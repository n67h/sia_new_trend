                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-6 mt-4">
                                            ...
                                            <div class="mb-3">
                                                <label for="edit_prod_img<?= $prod_id ?>" class="form-label fs-5 ps-2">Select image</label>
                                                <input class="form-control" type="file" id="edit_prod_img<?= $prod_id ?>" name="edit_prod_img">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-7 col-6 mt-3">
                                            <div class="col-md-12 col-6">
                                                <div class="form-group">
                                                    <label for="edit_prod_cat<?= $prod_id ?>" class="ps-2 pb-2 fs-5">Category</label>
                                                    <select class="form-select" aria-label="Default select example" name="edit_prod_cat" id="edit_prod_cat<?= $prod_id ?>" required>
                                                        <?php
                                            ...
                                            <div class="col-md-12 col-6 mt-3">
                                                <div class="form-group">
                                                    <label for="edit_prod_name<?= $prod_id ?>" class="ps-2 pb-2 fs-5">Product name</label>
                                                    <input type="text" class="form-control" name="edit_prod_name" id="edit_prod_name<?= $prod_id ?>" value="<?= $prod_name ?>" required>
                                                </div>
                                            </div>

                                            <div class="col-md-12 col-6 mt-3">
                                                <div class="form-group">
                                                    <label for="edit_prod_price<?= $prod_id ?>" class="ps-2 pb-2 fs-5">Price</label>
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text" id="basic-editon1">₱</span>
                                                        <input type="number" class="form-control" name="edit_prod_price" id="edit_prod_price<?= $prod_id ?>" placeholder="" aria-label="" aria-describedby="basic-addon1" value="<?= $prod_price ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-6 mt-3">
                                            <div class="form-group">
                                                <label for="edit_prod_desc<?= $prod_id ?>" class="ps-2 pb-2 fs-5">Product description</label>
                                                <div class="form-floating">
                                                    <textarea class="form-control" placeholder="Leave a comment here" id="edit_prod_desc<?= $prod_id ?>" style="height: 100px" name="edit_prod_desc" value="" required><?= $prod_desc ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
